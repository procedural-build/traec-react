...
export const postLogin = (body, fetchParams) => {
    fetchParams = Object.assign(
        { url: "/auth-jwt/get/", method: 'POST' }, {body}, fetchParams
    )
    return ({
        APICallTypes: { 
...
export const postRegistration = (body, fetchParams) => {
    fetchParams = Object.assign(
        { url: "/auth-rest/register/", method: 'POST' }, {body}, fetchParams
    )
    return ({
        APICallTypes: { 
...
export const putActivation = (body, fetchParams) => {
    fetchParams = Object.assign(
        { url: "/auth-rest/register/activate/", method: 'PUT' }, {body}, fetchParams
    )
    return ({
        APICallTypes: { 
...
export const postPasswordReset = (body, fetchParams) => {
    fetchParams = Object.assign(
        { url: "/auth-rest/password/reset/", method: 'POST' }, {body}, fetchParams
    )
    return ({
        APICallTypes: { 
...
export const postPasswordResetConfirm = (body, fetchParams) => {
    fetchParams = Object.assign(
        { url: "/auth-rest/password/reset/confirm/", method: 'POST' }, {body}, fetchParams
    )
    return ({
        APICallTypes: { 
